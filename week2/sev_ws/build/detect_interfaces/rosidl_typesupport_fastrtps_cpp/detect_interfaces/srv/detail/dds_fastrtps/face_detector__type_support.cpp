...
#include "detect_interfaces/srv/detail/face_detector__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = detect_interfaces::srv::FaceDetector_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const detect_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detect_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  return &detect_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = detect_interfaces::srv::FaceDetector_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const detect_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<detect_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &detect_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
{
  return &detect_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
