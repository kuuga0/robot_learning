...
bool robot_interfaces__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // control
    ...
    if (!std_msgs__msg__float64__convert_from_py(field, &ros_message->control)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // stable
    ...
    if (!std_msgs__msg__bool__convert_from_py(field, &ros_message->stable)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * robot_interfaces__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._robot_status");
  ...
  {  // control
    PyObject * field = NULL;
    field = std_msgs__msg__float64__convert_to_py(&ros_message->control);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // stable
    PyObject * field = NULL;
    field = std_msgs__msg__bool__convert_to_py(&ros_message->stable);
    if (!field) {
      return NULL;
    }
    {
