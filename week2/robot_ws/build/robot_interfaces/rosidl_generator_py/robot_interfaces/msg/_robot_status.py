...
class RobotStatus(metaclass=Metaclass_RobotStatus):
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float64
        self.control = kwargs.get('control', Float64())
        from std_msgs.msg import Bool
        self.stable = kwargs.get('stable', Bool())
    ...
    def control(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'control' field must be a sub message of type 'Float64'"
        self._control = value
    ...
    def stable(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'stable' field must be a sub message of type 'Bool'"
        self._stable = value
