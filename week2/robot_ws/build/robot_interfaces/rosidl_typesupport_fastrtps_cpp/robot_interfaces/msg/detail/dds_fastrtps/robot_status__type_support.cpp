...
#include "robot_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, RobotStatus)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
