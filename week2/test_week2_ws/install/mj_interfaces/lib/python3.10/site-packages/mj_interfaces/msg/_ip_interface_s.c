...
bool mj_interfaces__msg__ip_interface__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mj_interfaces.msg._ip_interface.IpInterface", full_classname_dest, 43) == 0);
  }
  mj_interfaces__msg__IpInterface * ros_message = _ros_message;
  {  // stamp
  ...
  {  // omega
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->omega)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of IpInterface */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mj_interfaces.msg._ip_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IpInterface");
  ...
  {  // omega
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->omega);
    if (!field) {
      return NULL;
    }
    {
