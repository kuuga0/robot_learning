...
bool status_interfaces__msg__systemstatus__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("status_interfaces.msg._systemstatus.Systemstatus", full_classname_dest, 48) == 0);
  }
...
PyObject * status_interfaces__msg__systemstatus__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("status_interfaces.msg._systemstatus");
