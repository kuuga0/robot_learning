...
static const _Systemstatus_type_support_symbol_names_t _Systemstatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, status_interfaces, msg, Systemstatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, status_interfaces, msg, Systemstatus)),
  }
};
...
{
  return &::status_interfaces::msg::rosidl_typesupport_cpp::Systemstatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, status_interfaces, msg, Systemstatus)() {
  return get_message_type_support_handle<status_interfaces::msg::Systemstatus>();
}
