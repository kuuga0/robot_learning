...
#ifndef STATUS_INTERFACES__MSG__DETAIL__SYSTEMSTATUS__STRUCT_H_
#define STATUS_INTERFACES__MSG__DETAIL__SYSTEMSTATUS__STRUCT_H_
...
#endif  // STATUS_INTERFACES__MSG__DETAIL__SYSTEMSTATUS__STRUCT_H_
